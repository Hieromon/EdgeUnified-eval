/*
  ...
  This example is for explaining how to use the EdgeUnified library, and it also
  suggests a way to write EdgeDriver source code files as pseudo discrete modules
  while still following the contexts of the One Definition Rule, the C++ standard.
...
// Note that all included source code files are treated by the compiler as a
// series of main.cpp, not separate compilation units. It should always follow
// the C++ standard.
#include "gpio.hpp"
#include "mqtt.hpp"
