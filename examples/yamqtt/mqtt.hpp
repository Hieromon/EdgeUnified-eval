/*
  ...
  mqtt.hpp is an implementation of GPIO EdgeDriver. EdgeDriver basically
...
/*
  The mqtt.hpp source code file is not a compilation unit. It suggests a way
 ...
 */
static const char SETTINGS_MQTT[] PROGMEM = R"*(
{
  "title": "MQTT Setting",
  "uri": "/mqtt_setting",
  "menu": true,
...
static const char START_MQTT[] PROGMEM = R"*(
{
  "title": "MQTT Setting",
  "uri": "/mqtt_start",
  "menu": false,
...
static const char CLEAR_MQTT[] PROGMEM = R"*(
{
  "title": "MQTT Setting",
  "uri": "/mqtt_clear",
  "menu": false,
...
static const char STOP_MQTT[] PROGMEM = R"*(
{
  "title": "MQTT Setting",
  "uri": "/mqtt_stop",
  "menu": false,
